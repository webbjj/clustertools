...
setuptools.setup(
    ...
    license='MIT',
    packages=["clustertools","clustertools/analysis","clustertools/cluster","clustertools/custom","clustertools/io","clustertools/planet","clustertools/simulate","clustertools/tidaltail","clustertools/util"],
